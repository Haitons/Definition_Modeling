...
if __name__ == '__main__':
    ...
    model = RNNModel(
        ...
        use_ch=True,use_he=True,use_i=False,use_h=True,use_g=False,**char_data).to(device)
    model.load_state_dict(torch.load(model_save_dir + 's+h+ch+he.pkl'),str(device))
    print(model)
    print('=============== end =================')
